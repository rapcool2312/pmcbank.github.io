<?php
session_start();
if(!isset($_SESSION['userId'])){ header('location:mindex.php');}
?>
<!DOCTYPE html>
<html>
<head>
...
<body style="background: url(images/bg-logn5.jpg);background-size: 100%">
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
 <a class="navbar-brand" href="#">
    <img src="images/logo3.png" width="30" height="30" class="d-inline-block align-top" alt="">
...
<div class="row w-100" >
  ...
  <h4 class="display-5">Welecome to PMC Bank</h4>
